...
class UsuarioRepository extends ServiceEntityRepository
{
    ...
    /**
     * Obtener usuarios con entrenador asignado
     */
    public function findConEntrenador(): array
    {
        return $this->createQueryBuilder('u')
            ->where('u.entrenador IS NOT NULL')
            ->orderBy('u.fechaAsignacionEntrenador', 'DESC')
            ->getQuery()
            ->getResult();
    }
     ...
     */
    public function findSinEntrenador(bool $soloPremium = false): array
    {
        $qb = $this->createQueryBuilder('u')
    ...
    /**
     * Buscar usuarios por entrenador
     */
    public function findByEntrenador(int $entrenadorId): array
    {
        return $this->createQueryBuilder('u')
            ->leftJoin('u.entrenador', 'e')
            ->where('e.id = :entrenadorId')
            ->setParameter('entrenadorId', $entrenadorId)
            ->orderBy('u.fechaAsignacionEntrenador', 'DESC')
            ->getQuery()
            ->getResult();
    }

...
function MisDatosPersonales() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasChanges) {
      setMessage({ type: "error", text: "No se han realizado cambios" });
      return;
    }
    ...
    try {
      ...
      // Guardar usuario actualizado en contexto y localStorage
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={!editing}
                    required
                    className="w-full px-4 py-3 bg-gray-900 border-b-2 border-uf-gold text-white disabled:bg-gray-800 disabled:text-gray-400"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={!editing}
                    className="w-full px-4 py-3 bg-gray-900 border-b-2 border-uf-gold text-white"
                  />
                </div>
            ...
            <div className="flex gap-4 pt-6">
              {!editing ? (
                <button
                  type="button"
                  onClick={handleEdit}
                  className="flex-1 bg-gradient-to-r from-uf-gold to-yellow-600 text-black font-bold py-4 rounded-lg uppercase tracking-wider shadow-xl hover:scale-105 transition"
                >
                ...
                <>
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 bg-gradient-to-r from-green-600 to-green-700 text-white font-bold py-4 rounded-lg uppercase tracking-wider shadow-xl disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-bold py-4 rounded-lg uppercase tracking-wider shadow-xl"
                  >
                    <X className="w-5 h-5" />
                    Cancelar
                  </button>

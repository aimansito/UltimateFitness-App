...
#[ApiResource(
    operations: []  // Deshabilitamos todas las operaciones automáticas de API Platform
)]
...
class Usuario implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\JoinColumn(name: 'entrenador_id', referencedColumnName: 'id', nullable: true, onDelete: 'SET NULL')]
    ...
    {
        if (!$this->pesoActual || !$this->altura || !$this->edad) {
            return;
        }
        ...
        // Usamos la fórmula general (promedio) sin distinción de sexo
    ...
    // ============================================
    // GETTERS/SETTERS ENTRENADOR ASIGNADO
    // ============================================

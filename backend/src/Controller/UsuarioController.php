...
class UsuarioController extends AbstractController
{
    ...
    public function actualizar(
        ...
        if (isset($data['peso_actual'])) {
            $usuario->setPesoActual((string)$data['peso_actual']);
        }
        if (isset($data['altura'])) {
            $usuario->setAltura((int)$data['altura']);
        }
        if (isset($data['nivel_actividad'])) {
            $usuario->setNivelActividad($data['nivel_actividad']);
        }

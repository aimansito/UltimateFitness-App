 ...
 */
class getSecurity_User_Provider_Concrete_EntrenadorProviderService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.entrenador_provider' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.entrenador_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($container->services['doctrine'] ?? self::getDoctrineService($container)), 'App\\Entity\\Entrenador', 'email', NULL);
    }
}

 ...
 */
class getCalendarioUsuarioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CalendarioUsuarioRepository' shared autowired service.
     *
     * @return \App\Repository\CalendarioUsuarioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalendarioUsuarioRepository.php';

        return $container->privates['App\\Repository\\CalendarioUsuarioRepository'] = new \App\Repository\CalendarioUsuarioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

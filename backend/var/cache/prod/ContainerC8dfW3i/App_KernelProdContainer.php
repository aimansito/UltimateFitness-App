...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AlimentoController' => 'getAlimentoControllerService',
            ...
            'App\\Controller\\CrearEntrenamientoController' => 'getCrearEntrenamientoControllerService',
            'App\\Controller\\DietaController' => 'getDietaControllerService',
            'App\\Controller\\DietasPublicasController' => 'getDietasPublicasControllerService',
            'App\\Controller\\EjercicioController' => 'getEjercicioControllerService',
            'App\\Controller\\EntrenadorAuthController' => 'getEntrenadorAuthControllerService',
            'App\\Controller\\EntrenadorController' => 'getEntrenadorControllerService',
            'App\\Controller\\EntrenadorDietasController' => 'getEntrenadorDietasControllerService',
            'App\\Controller\\EntrenadorEntrenamientoDetalleController' => 'getEntrenadorEntrenamientoDetalleControllerService',
            'App\\Controller\\EntrenadorEntrenamientosController' => 'getEntrenadorEntrenamientosControllerService',
            'App\\Controller\\EntrenamientoController' => 'getEntrenamientoControllerService',
            'App\\Controller\\GuardarDietaController' => 'getGuardarDietaControllerService',
            'App\\Controller\\MisClientesController' => 'getMisClientesControllerService',
            'App\\Controller\\MisDietasController' => 'getMisDietasControllerService',
            ...
            'App\\Controller\\PlatoController' => 'getPlatoControllerService',
            'App\\Controller\\PublicBlogController' => 'getPublicBlogControllerService',
            'App\\Controller\\RegistroController' => 'getRegistroControllerService',
            'App\\Controller\\SubscripcionController' => 'getSubscripcionControllerService',
            'App\\Controller\\TestTokenController' => 'getTestTokenControllerService',
            'App\\Controller\\UsuarioController' => 'getUsuarioControllerService',
            'App\\Controller\\UsuarioDietasController' => 'getUsuarioDietasControllerService',
            'App\\Controller\\UsuarioEntrenamientosController' => 'getUsuarioEntrenamientosControllerService',
            'App\\Security\\EntrenadorLoginSuccessHandler' => 'getEntrenadorLoginSuccessHandlerService',
        ...
        $this->aliases = [
            ...
            'App\\Kernel' => 'kernel',
            'App\\Security\\UsuarioLoginSuccessHandler' => 'App\\Security\\EntrenadorLoginSuccessHandler',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TGzU7u1pcH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AlimentoRepository' => ['privates', 'App\\Repository\\AlimentoRepository', 'getAlimentoRepositoryService', true],
            'App\\Repository\\BlogPostRepository' => ['privates', 'App\\Repository\\BlogPostRepository', 'getBlogPostRepositoryService', true],
            'App\\Repository\\CalendarioUsuarioRepository' => ['privates', 'App\\Repository\\CalendarioUsuarioRepository', 'getCalendarioUsuarioRepositoryService', true],
            'App\\Repository\\DiaEjercicioRepository' => ['privates', 'App\\Repository\\DiaEjercicioRepository', 'getDiaEjercicioRepositoryService', true],
            'App\\Repository\\DiaEntrenamientoRepository' => ['privates', 'App\\Repository\\DiaEntrenamientoRepository', 'getDiaEntrenamientoRepositoryService', true],
            'App\\Repository\\DietaPlatoRepository' => ['privates', 'App\\Repository\\DietaPlatoRepository', 'getDietaPlatoRepositoryService', true],
            'App\\Repository\\DietaRepository' => ['privates', 'App\\Repository\\DietaRepository', 'getDietaRepositoryService', true],
            'App\\Repository\\EjercicioRepository' => ['privates', 'App\\Repository\\EjercicioRepository', 'getEjercicioRepositoryService', true],
            'App\\Repository\\EntrenadorRepository' => ['privates', 'App\\Repository\\EntrenadorRepository', 'getEntrenadorRepositoryService', true],
            'App\\Repository\\EntrenamientoEjercicioRepository' => ['privates', 'App\\Repository\\EntrenamientoEjercicioRepository', 'getEntrenamientoEjercicioRepositoryService', true],
            'App\\Repository\\EntrenamientoRepository' => ['privates', 'App\\Repository\\EntrenamientoRepository', 'getEntrenamientoRepositoryService', true],
            'App\\Repository\\HistorialPagoRepository' => ['privates', 'App\\Repository\\HistorialPagoRepository', 'getHistorialPagoRepositoryService', true],
            'App\\Repository\\PlatoRepository' => ['privates', 'App\\Repository\\PlatoRepository', 'getPlatoRepositoryService', true],
            'App\\Repository\\SuscripcionRepository' => ['privates', 'App\\Repository\\SuscripcionRepository', 'getSuscripcionRepositoryService', true],
            ...
            'App\\Repository\\PlatoRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventListener\\ResponseListener')] fn () => ($container->privates['App\\EventListener\\ResponseListener'] ??= new \App\EventListener\ResponseListener()), '__invoke'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\AlimentoController', 'App\\Controller\\AuthController', 'App\\Controller\\BlogController', 'App\\Controller\\CalendarioController', 'App\\Controller\\CrearEntrenamientoController', 'App\\Controller\\DietaController', 'App\\Controller\\DietasPublicasController', 'App\\Controller\\EjercicioController', 'App\\Controller\\EntrenadorAuthController', 'App\\Controller\\EntrenadorController', 'App\\Controller\\EntrenadorDietasController', 'App\\Controller\\EntrenadorEntrenamientoDetalleController', 'App\\Controller\\EntrenadorEntrenamientosController', 'App\\Controller\\EntrenamientoController', 'App\\Controller\\GuardarDietaController', 'App\\Controller\\MisClientesController', 'App\\Controller\\MisDietasController', 'App\\Controller\\PagoController', 'App\\Controller\\PasswordResetController', 'App\\Controller\\PlatoController', 'App\\Controller\\PublicBlogController', 'App\\Controller\\RegistroController', 'App\\Controller\\SubscripcionController', 'App\\Controller\\TestTokenController', 'App\\Controller\\UsuarioController', 'App\\Controller\\UsuarioDietasController', 'App\\Controller\\UsuarioEntrenamientosController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /*
     * Gets the private '.service_locator.SOM6acW' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_SOM6acWService($container)
    {
        return $container->privates['.service_locator.SOM6acW'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'security.firewall.map.context.dev' => ['privates', 'security.firewall.map.context.dev', 'getSecurity_Firewall_Map_Context_DevService', true],
            'security.firewall.map.context.login_user' => ['privates', 'security.firewall.map.context.login_user', 'getSecurity_Firewall_Map_Context_LoginUserService', true],
            'security.firewall.map.context.login_trainer' => ['privates', 'security.firewall.map.context.login_trainer', 'getSecurity_Firewall_Map_Context_LoginTrainerService', true],
            ...
            'security.firewall.map.context.login_user' => '?',
            'security.firewall.map.context.login_trainer' => '?',
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VEC0rCs6b+', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3W+bCPl-rd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VkkmcEVOLi', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('2t-l6NOSGp', 0, $container->getParameter('container.build_id'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cXagxF8Jjk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ST8AKYzyQN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CAs8TOVGvB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G7Jl4n5xJ7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5CZPX8ra+0', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hJirruF0eY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $a = ($container->privates['.service_locator.SOM6acW'] ?? self::get_ServiceLocator_SOM6acWService($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.login_user' => ($container->privates['.security.request_matcher.gcxynGs'] ?? $container->load('get_Security_RequestMatcher_GcxynGsService'));
            yield 'security.firewall.map.context.login_trainer' => ($container->privates['.security.request_matcher.s6wx24u'] ?? $container->load('get_Security_RequestMatcher_S6wx24uService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'nelmio_cors.map' => [
                '^/' => [
                    'allow_origin' => [
                        0 => 'https://ultimatefitnessuf.com',
                        1 => 'https://api.ultimatefitnessuf.com',
                    ],
                    'allow_headers' => [
                        0 => 'content-type',
                        1 => 'authorization',
            ...
            'api_platform.title' => 'Ultimate Fitness API',
